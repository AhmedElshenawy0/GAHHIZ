...
export default function Cases() {
  ...
  return (
    <section
      dir="rtl"
      className="bg-gradient-to-b from-[#f7f8fa] to-[#f3f4f6] py-24 px-4 sm:px-10 md:px-20 font-arabic text-right"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-20">
          {images.map((src, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:scale-105 transition-transform duration-300 bg-white"
            >
              <img
                src={src}
                alt={`product-${i}`}
        ...
        <div className="flex flex-col md:flex-row gap-12 items-stretch mb-20">
          ...
          >
            <h3 className="text-2xl font-bold text-[#3e2723] mb-4">الصالون</h3>
          ...
          <motion.div
            ...
            className="flex-1 bg-white rounded-xl p-6 shadow-md"
          >
            <h3 className="text-2xl font-bold text-[#3e2723] mb-4">الديكور</h3>
            <p className="text-gray-700 leading-relaxed">
